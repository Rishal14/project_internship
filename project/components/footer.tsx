        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <AnimatedSection delay={0.1} className="space-y-4">
            <div className="flex items-center space-x-3">
              <motion.div 
                className="w-12 h-12 bg-gradient-to-br from-orange-500 to-orange-600 rounded-md flex items-center justify-center transform rotate-45"
                whileHover={{ rotate: 55, scale: 1.1 }}
              ...
              <div>
                ...
                <div className="text-xs text-orange-400 font-medium tracking-wide">GULF TECHNICAL OPERATIONS</div>
              </div>
            </div>
            <p className="text-sm">
                ...
                <li key={link.name}>
                  <Link href={link.href} passHref>
                    <motion.div className="relative inline-block cursor-pointer group" whileHover="hover" initial="rest" animate="rest">
                      ...
                      <motion.div className="absolute bottom-[-2px] left-0 h-0.5 bg-orange-500" variants={linkHover} />
                    </motion.div>
                  </Link>
                </li>
              ))}
          ...
          <AnimatedSection delay={0.4} className="space-y-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-3"><Phone size={16} className="text-orange-400" /><span>+1 972 214 7001</span></li>
              <li className="flex items-center space-x-3"><Mail size={16} className="text-orange-400" />
                <a href="mailto:sales@gtexas.com" className="hover:text-orange-400 transition-colors">sales@gtexas.com</a>
              </li>
              <li className="flex items-start space-x-3"><MapPin size={16} className="text-orange-400 mt-1 flex-shrink-0" /><span>Rockwall, Texas, USA</span></li>
            </ul>
      ...
      <div className="relative z-10 border-t border-white/10 mt-8">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-center items-center">
          ...
          <motion.button
            ...
            className="absolute right-4 sm:right-6 lg:right-8 w-10 h-10 bg-orange-500/80 backdrop-blur-sm border border-white/20 rounded-full flex items-center justify-center hover:bg-orange-500 transition-colors duration-300"
