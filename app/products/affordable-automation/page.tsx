...
const sections = [
  ...
  { id: "plc-systems", label: "PLC Systems" },
  { id: "scada-solutions", label: "SCADA Solutions" },
  { id: "hmi-interfaces", label: "HMI Interfaces" },
...
const sectionContents: Record<string, React.ReactNode> = {
  introduction: (
    ...
    >
      ...
      >
        ...
        >
          Affordable Automation Products
        </motion.span>
      </motion.h2>
      ...
      >
        ...
        >
          ...
          >
            Cost-effective automation solutions designed to enhance operational efficiency in the oil and gas industry.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            Our comprehensive automation portfolio includes PLC systems, SCADA solutions, HMI interfaces, and advanced sensor networks that provide real-time monitoring and control capabilities.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            Designed with affordability in mind, our automation products deliver enterprise-grade functionality without the premium price tag, making advanced automation accessible to operations of all sizes.
          </motion.p>
        </motion.div>
      </motion.div>
    </motion.div>
  ...
  "plc-systems": (
    <div className="space-y-6">
      <h2 className="text-3xl font-bold text-gray-900 mt-2 mb-2">PLC Systems</h2>
      <p className="text-base text-gray-800 max-w-3xl">
        Programmable Logic Controllers designed for reliable automation in harsh oilfield environments with robust performance and easy programming.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">Compact PLCs</span><br />
          <span>Space-efficient solutions for smaller applications</span>
        </div>
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">Modular PLCs</span><br />
          <span>Scalable systems for complex automation needs</span>
        </div>
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">Safety PLCs</span><br />
          <span>SIL-rated controllers for critical safety functions</span>
        </div>
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">Programming Software</span><br />
          <span>User-friendly development environments</span>
        </div>
      </div>
    </div>
  ),
      ...
      >
        ...
        >
          <p className="text-lg text-gray-700">
            Detailed information about {section?.label.toLowerCase()} will be available soon. Our team is working on comprehensive documentation for all our automation categories.
          </p>
        </motion.div>
      </motion.div>
    );
...
export default function AffordableAutomation() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <motion.div
        ...
        style={{
          backgroundImage: "url('/products/AA1.png')",
