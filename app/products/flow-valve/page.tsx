...
const sections = [
  ...
  { id: "ball-valves", label: "Ball Valves" },
  { id: "gate-valves", label: "Gate Valves" },
  { id: "check-valves", label: "Check Valves" },
  { id: "butterfly-valves", label: "Butterfly Valves" },
  { id: "control-valves", label: "Control Valves" },
  { id: "safety-valves", label: "Safety Valves" },
  { id: "needle-valves", label: "Needle Valves" },
];
...
const sectionContents: Record<string, React.ReactNode> = {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Gulf Technical Operations provides comprehensive flow valve solutions for the oil and gas industry.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            Our extensive range of valves includes ball valves, gate valves, check valves, and specialized control systems designed for optimal flow management in demanding oilfield environments.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            With decades of experience in the industry, we provide reliable valve solutions that ensure safe and efficient operations across all phases of oil and gas production.
          </motion.p>
        </motion.div>
      </motion.div>
    </motion.div>
  ...
  "ball-valves": (
    <div className="space-y-6">
      <h2 className="text-3xl font-bold text-gray-900 mt-2 mb-2">Ball Valves</h2>
      <p className="text-base text-gray-800 max-w-3xl">
        Our ball valves provide reliable shut-off and flow control for oil and gas applications. Designed for high-pressure environments with excellent sealing capabilities.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">2-Piece Ball Valve</span><br />
          <span>High-pressure rated for upstream applications</span>
        </div>
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">3-Piece Ball Valve</span><br />
          <span>Easy maintenance with removable center section</span>
        </div>
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">Floating Ball Design</span><br />
          <span>Optimal sealing performance</span>
        </div>
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">Trunnion Mounted</span><br />
          <span>Heavy-duty applications with reduced torque</span>
        </div>
      </div>
    </div>
  ),
      ...
      >
        ...
        >
          <p className="text-lg text-gray-700">
            Detailed information about {section?.label.toLowerCase()} will be available soon. Our team is working on comprehensive documentation for all our valve categories.
          </p>
        </motion.div>
      </motion.div>
    );
...
export default function FlowValve() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <motion.div
        ...
        style={{
          backgroundImage: "url('/products/FLOWVALVE.png')",
          ...
          <div className="max-w-7xl mx-auto px-4 py-20">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="hidden md:flex flex-1 items-center justify-end">
                <img
                  src="/services/FLOW_VALVE.png"
                  alt="Flow Valve Solutions"
