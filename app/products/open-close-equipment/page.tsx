...
const sections = [
  ...
  { id: "blowout-preventers", label: "Blowout Preventers" },
  { id: "choke-manifolds", label: "Choke Manifolds" },
  { id: "kill-manifolds", label: "Kill Manifolds" },
  { id: "drilling-spools", label: "Drilling Spools" },
  { id: "wellhead-equipment", label: "Wellhead Equipment" },
  { id: "pressure-testing", label: "Pressure Testing Equipment" },
...
const sectionContents: Record<string, React.ReactNode> = {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Specialized equipment for critical open and close operations in oilfield environments.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            Our comprehensive range includes blowout preventers, choke manifolds, kill manifolds, and wellhead equipment designed for the highest safety standards and operational reliability.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            Built to withstand extreme pressures and harsh conditions, our equipment ensures safe and efficient well control operations throughout the drilling and production lifecycle.
          </motion.p>
        </motion.div>
      </motion.div>
    </motion.div>
  ...
  "blowout-preventers": (
    <div className="space-y-6">
      <h2 className="text-3xl font-bold text-gray-900 mt-2 mb-2">Blowout Preventers (BOPs)</h2>
      <p className="text-base text-gray-800 max-w-3xl">
        Critical safety equipment designed to prevent uncontrolled release of crude oil or natural gas from wells during drilling operations.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">Ram BOPs</span><br />
          <span>Pipe rams, blind rams, and shear rams for complete well control</span>
        </div>
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">Annular BOPs</span><br />
          <span>Flexible sealing around various pipe sizes</span>
        </div>
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">Stack Configurations</span><br />
          <span>Custom BOP stack designs for specific applications</span>
        </div>
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">Control Systems</span><br />
          <span>Hydraulic and electric control systems</span>
        </div>
      </div>
    </div>
  ),
      ...
      >
        ...
        >
          <p className="text-lg text-gray-700">
            Detailed information about {section?.label.toLowerCase()} will be available soon. Our team is working on comprehensive documentation for all our equipment categories.
          </p>
        </motion.div>
      </motion.div>
    );
...
export default function OpenCloseEquipment() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <motion.div
        ...
        style={{
          backgroundImage: "url('/products/OPENCLOSE.png')",
          ...
          <div className="max-w-7xl mx-auto px-4 py-20">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="hidden md:flex flex-1 items-center justify-end">
                <img
                  src="/services/OPEN_CLOSE.png"
                  alt="Open & Close Equipment"
