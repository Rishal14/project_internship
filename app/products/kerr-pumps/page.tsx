...
const sections = [
  ...
  { id: "centrifugal-pumps", label: "Centrifugal Pumps" },
  { id: "positive-displacement", label: "Positive Displacement Pumps" },
  { id: "submersible-pumps", label: "Submersible Pumps" },
  { id: "mud-pumps", label: "Mud Pumps" },
  { id: "chemical-pumps", label: "Chemical Injection Pumps" },
  { id: "booster-pumps", label: "Booster Pumps" },
...
const sectionContents: Record<string, React.ReactNode> = {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            KERR Pumps represents the pinnacle of pumping technology for the oil and gas industry.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            Our comprehensive range includes centrifugal pumps, positive displacement pumps, submersible systems, and specialized mud pumps designed for the most demanding oilfield applications.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            With proven reliability and exceptional performance, KERR Pumps deliver the efficiency and durability required for continuous operation in harsh environments.
          </motion.p>
        </motion.div>
      </motion.div>
    </motion.div>
  ...
  "centrifugal-pumps": (
    <div className="space-y-6">
      <h2 className="text-3xl font-bold text-gray-900 mt-2 mb-2">Centrifugal Pumps</h2>
      <p className="text-base text-gray-800 max-w-3xl">
        High-efficiency centrifugal pumps designed for continuous operation in oil and gas applications. Built for reliability and optimal performance.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">Single Stage Pumps</span><br />
          <span>High flow rates with excellent efficiency</span>
        </div>
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">Multi-Stage Pumps</span><br />
          <span>High pressure applications with multiple impellers</span>
        </div>
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">API 610 Compliant</span><br />
          <span>Meeting industry standards for reliability</span>
        </div>
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">Corrosion Resistant</span><br />
          <span>Special alloys for harsh environments</span>
        </div>
      </div>
    </div>
  ),
      ...
      >
        ...
        >
          <p className="text-lg text-gray-700">
            Detailed information about {section?.label.toLowerCase()} will be available soon. Our team is working on comprehensive documentation for all our pump categories.
          </p>
        </motion.div>
      </motion.div>
    );
...
export default function KerrPumps() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <motion.div
        ...
        style={{
          backgroundImage: "url('/products/KERR.png')",
