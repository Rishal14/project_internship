...
const sections = [
  ...
  { id: "flow-control-tools", label: "Flow Control Tools" },
  { id: "downhole-equipment", label: "Downhole Equipment" },
  { id: "surface-equipment", label: "Surface Equipment" },
  { id: "completion-tools", label: "Completion Tools" },
  { id: "production-optimization", label: "Production Optimization" },
  { id: "well-intervention", label: "Well Intervention" },
...
const sectionContents: Record<string, React.ReactNode> = {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            SILVER FOX represents cutting-edge flow control technology for the modern oil and gas industry.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            Our comprehensive suite includes advanced downhole and surface equipment, completion tools, and production optimization solutions designed to maximize well performance and operational efficiency.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            Engineered for precision and reliability, SILVER FOX tools deliver exceptional performance in the most challenging downhole environments, ensuring optimal flow control throughout the well lifecycle.
          </motion.p>
        </motion.div>
      </motion.div>
    </motion.div>
  ...
  "flow-control-tools": (
    <div className="space-y-6">
      <h2 className="text-3xl font-bold text-gray-900 mt-2 mb-2">Flow Control Tools</h2>
      <p className="text-base text-gray-800 max-w-3xl">
        Advanced flow control solutions designed for precise regulation of fluid flow in downhole and surface applications.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">Inflow Control Devices</span><br />
          <span>Optimize production by controlling fluid entry</span>
        </div>
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">Autonomous ICDs</span><br />
          <span>Self-regulating flow control technology</span>
        </div>
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">Flow Control Valves</span><br />
          <span>Precision valves for accurate flow management</span>
        </div>
        <div className="border rounded-lg p-4 bg-white">
          <span className="font-bold">Sliding Sleeves</span><br />
          <span>Adjustable flow control for zone isolation</span>
        </div>
      </div>
    </div>
  ),
      ...
      >
        ...
        >
          <p className="text-lg text-gray-700">
            Detailed information about {section?.label.toLowerCase()} will be available soon. Our team is working on comprehensive documentation for all our SILVER FOX categories.
          </p>
        </motion.div>
      </motion.div>
    );
...
export default function SilverFox() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <motion.div
        ...
        style={{
          backgroundImage: "url('/products/SILVERSTONE1.png')",
